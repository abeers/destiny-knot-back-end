class TeamMembersController < ProtectedController
  skip_before_action :authenticate, only: [:index, :show]
  before_action :set_team_member, only: [:show]
  before_action :set_user_team_member, only: [:update, :destroy]
